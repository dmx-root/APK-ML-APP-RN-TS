import { get_all_ocr_production, get_all_op_production }                 from '../../endpoints/ml_api/restApiMujerLatina';
...
export const useApiGetOpByUser = (documentId:string): { state: ApiState } => {
    ...
    async function fetchData():Promise<void>{
        try {
            ...
            const data=await apiQuery.OpProductionGet(get_all_op_production,documentId);
