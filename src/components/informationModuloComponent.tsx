...
export function InformationModuloComponent({handlerClick}:{
    handlerClick:(event:GestureResponderEvent)=>void
}){
    return <View style={ocrStyle.container}>
                <View style={ocrStyle.header1}>
                    <View style={ocrStyle.iconContainer}>
                        <ModuloIcon color='#AAA' size={45} width={1.2}/>
                    </View>
                    <View style={ocrStyle.rowField}>
                        <View style={ocrStyle.rowContente}>
                            <View style={ocrStyle.fieldContainer}>
                                <Text style={ocrStyle.labelTitle}>MÓDULO 2</Text>
                            </View>
                        </View>
                        <View style={ocrStyle.rowContente}>
                            <View style={ocrStyle.fieldContainer}>
                                <Text style={[ocrStyle.labelTitle,{fontWeight:'normal'}]}>12 Operarios</Text>
                                {/* <OcrIcon color='#999' size={20} width={2}/> */}
                            </View>
                        </View>
                        <View style={ocrStyle.rowContente}>
                            <View style={ocrStyle.fieldContainer}>
                                <Text style={[ocrStyle.labelTitle,{fontWeight:'normal'}]}>OP en proceso MOP3458</Text>
                            </View>
                        </View>
                    </View>
                    <View style={ocrStyle.rowField}>
                        <View style={ocrStyle.rowContente}>
                            <View style={ocrStyle.fieldContainer}>
                                <Text style={ocrStyle.labelTitle}>200 unidades planeadas</Text>
                            </View>
                        </View>
                        <View style={ocrStyle.rowContente}>
                            <View style={ocrStyle.fieldContainer}>
                                <Text style={[ocrStyle.labelTitle,{fontWeight:'normal'}]}>100 unidades ejecutadas</Text>
                                {/* <ModuloIcon color='#999' size={20} width={2}/> */}
                            </View>
                        </View>
                        <View style={ocrStyle.rowContente}>
                            <View style={ocrStyle.fieldContainer}>
                                <Text style={[ocrStyle.labelTitle,{fontWeight:'normal'}]}>100 Unidades sin ejecutar</Text>
                            </View>
                        </View>
