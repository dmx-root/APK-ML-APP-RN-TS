...
export const FILTER_ITEMS_OCR_HOME:Array<FilterItem>=[
    {id:1,label:'Todos'},
...
export const FILTER_ITEMS_OP_HOME:Array<FilterItem>=[
    {id:1,label:'Todas'},
...
export const FILTER_ITEMS_MODULOS_HOME:Array<FilterItem>=[
    {id:1,label:'Todos'},
    {id:2,label:'Módulos activos '},
    {id:3,label:'Módulos inactivos'}
]

export const FILTER_ITEMS_EMPLOYEERS_HOME:Array<FilterItem>=[
    {id:1,label:'Todos'},
